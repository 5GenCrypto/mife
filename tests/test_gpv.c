...
int main(int argc, char *argv[]) {
  ...
  status += test_gpv_run( test_dist_simple( 100,  100,  3.0, 1<<14, state) );
  status += test_gpv_run( test_dist_simple( 100,  100, 25.2, 1<<12, state) );
  status += test_gpv_run( test_dist_simple( 512,  512, 30.0, 1<<10, state) );

  status += test_gpv_run( test_dist_simple( 1,   10,  3.0, 1<<14, state) );
  status += test_gpv_run( test_dist_simple( 1,  100,  3.0, 1<<14, state) );
  status += test_gpv_run( test_dist_simple( 1,  100, 25.2, 1<<12, state) );
  status += test_gpv_run( test_dist_simple( 1,  512, 30.0, 1<<10, state) );
...

  {
    ...
    status += test_gpv_run( test_gso(4,4, M, G) );
  }

  {
    ...
    status += test_gpv_run( test_gso(3,3, M, G) );
  }

  {
    ...
    status += test_gpv_run( test_gso(1,4, M, G) );
  }
